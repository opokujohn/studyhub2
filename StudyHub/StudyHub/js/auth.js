...
class AuthSystem {
    ...
    initAuth() {
        onAuthStateChanged(auth, (user) => {
            ...
            // Deny access to protected pages for non-users
            if (!user && (window.location.pathname.includes('notes.html') || window.location.pathname.includes('quiz.html') || window.location.pathname.includes('games.html'))) {
